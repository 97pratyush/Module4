...
//		driver = new FirefoxDriver();
		...
		driver.get("file:///C:/Capgemini/Module%204/login.html");
	...
	public void navigate_to_hotelBooking() throws Throwable {
	   ...
	   driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	   driver.navigate().to("file:///C:/Capgemini/Module%204/hotelbooking.html");
	...
	public void user_doesnot_enter_either_username_or_password() throws Throwable {
	    ...
	    objhlpg.setPfpwd("capg123");	Thread.sleep(1000);
	}
